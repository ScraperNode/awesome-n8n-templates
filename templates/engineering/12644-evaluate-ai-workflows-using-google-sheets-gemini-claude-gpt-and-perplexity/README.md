# ⚒️ Evaluate AI workflows using Google Sheets, Gemini, Claude, GPT, and Perplexity
...
Gmail, Gmail Trigger, AI Agent, Summarization Chain, Anthropic Chat Model, OpenAI Chat Model
