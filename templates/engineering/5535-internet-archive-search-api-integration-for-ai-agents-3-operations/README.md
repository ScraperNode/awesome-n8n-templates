# ⚒️ Internet Archive search API integration for AI agents (3 operations)
...
2. **Credentials** Add Search Services credentials
...
**Response Format**: Native Search Services API responses with full data structure
