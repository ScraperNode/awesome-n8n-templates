...
This template is featured in the n8n Starter Guide series. The template is free, but comes with two additional PDFs and a Quick Start video if you grab the **[full download pack on gumroad](https://iversusai.gumroad.com/l/n8nstartupguidepack)**.
...
Dropbox, Email Trigger (IMAP), Google Sheets, HTTP Request, Rename Keys, RSS Read
