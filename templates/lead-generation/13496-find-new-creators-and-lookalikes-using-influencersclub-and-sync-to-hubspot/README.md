# 🎣 Find new creators and lookalikes using influencers.club and sync to HubSpot
...
HubSpot, Schedule Trigger, AI Agent, OpenAI Chat Model, Structured Output Parser
